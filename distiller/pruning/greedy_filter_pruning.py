...
def prune_tensor(param, param_name, fraction_to_prune, zeros_mask_dict):
    ...
    pruner = distiller.pruning.L1RankedStructureParameterPruner(name=None,
                                                                ...
                                                                weights=param_name, group_dependency=isinstance(param_name, list))
...
resnet50_params = [["module.layer4.0.conv3.weight", "module.layer4.1.conv3.weight", "module.layer4.2.conv3.weight", "module.layer4.0.shortcut,0.weight"]]
...
mobilenetv1_params = ["module.layers.0.conv2.weight", "module.layers.1.conv2.weight", "module.layers.2.conv2.weight",
                      "module.layers.3.conv2.weight", "module.layers.4.conv2.weight", "module.layers.5.conv2.weight",
                      "module.layers.6.conv2.weight", "module.layers.7.conv2.weight", "module.layers.8.conv2.weight",

                      "module.layers.9.conv2.weight", "module.layers.10.conv2.weight", "module.layers.11.conv2.weight",
                      "module.layers.12.conv2.weight"]
# mobilenetv1_params = ['module.layers.0.conv2.weight']
def greedy_pruner(pruned_model, app_args, fraction_to_prune, pruning_step, test_fn, train_fn, writer=None):
    dataset = app_args.dataset
    arch = app_args.arch
    ...
    logging.info('fraction_to_prune * dense_total_macs = %f' % (fraction_to_prune * dense_total_macs))
    iteration = 0
    model = pruned_model
